...
namespace PolePosition.UI
{
    public class PlayerInfoPanelController : MonoBehaviour
    {
        ...
        {
            TimeSpan timeSpan = TimeSpan.FromMilliseconds(interval * 1000);
            _intervalText.text = string.Format("+{0:D2}:{1:D2}:{2:D2}", timeSpan.Minutes, timeSpan.Seconds,
        ...
        public void UpdateData(int position, Color color, string playerName, float interval, float lapTime)
        {
